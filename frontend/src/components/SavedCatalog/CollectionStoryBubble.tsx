  ...
  if (isAddButton) {
    return (
      <button
        ...
        aria-label={title}
      >
        <div className="w-16 h-16 rounded-2xl bg-emerald-500/10 hover:bg-emerald-500/15 dark:bg-emerald-500/15 dark:hover:bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 flex items-center justify-center transition-colors border-none shadow-none">
  ...
  return (
    ...
    >
      ...
      {imageUrl ? (
        ...
        <div className="w-16 h-16 rounded-2xl border-2 border-dashed border-gray-200 dark:border-gray-700 bg-gray-50/60 dark:bg-gray-800/30 flex items-center justify-center relative overflow-hidden transition-colors group-hover:border-gray-300 dark:group-hover:border-gray-600">
          <Plus className="w-5 h-5 text-gray-400 dark:text-gray-500 group-hover:text-gray-600 dark:group-hover:text-gray-300 transition-colors" />
        </div>
      )}
