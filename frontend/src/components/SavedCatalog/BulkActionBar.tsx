      ...
      <div className="flex items-center justify-between px-1">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            type="button"
            onClick={onCancel}
            className="text-xs font-medium text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 active:scale-95 transition-all cursor-pointer border-none bg-transparent"
          >
      ...
      <div className="flex flex-col gap-2 w-full mt-1">
        ...
        <div className="flex gap-2 w-full">
          <Button
            ...
            className="flex-1 bg-amber-500/10 dark:bg-amber-500/15 border-none text-amber-800 dark:text-amber-300 hover:bg-amber-500/20 dark:hover:bg-amber-500/25 text-sm h-11 font-medium rounded-xl flex items-center justify-center gap-1.5 active:scale-95 transition-all min-w-0"
          >
        ...
        <div className="flex gap-2 w-full">
          ...
          <Button
            ...
            isDisabled={selectedCount === 0}
            className="flex-1 bg-rose-500/10 dark:bg-rose-500/15 border-none text-rose-600 dark:text-rose-400 hover:bg-rose-500/20 dark:hover:bg-rose-500/25 text-sm h-11 font-medium rounded-xl flex items-center justify-center gap-1.5 active:scale-95 transition-all min-w-0"
          >
