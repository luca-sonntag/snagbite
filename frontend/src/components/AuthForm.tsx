            ...
            {showEmailLogin ? (
              ...
              <div className="flex flex-col gap-2.5">
                ...
                <button
                  ...
                  className="w-full text-xs font-semibold text-gray-500 dark:text-gray-400 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors py-2 px-3 rounded-xl hover:bg-black/5 dark:hover:bg-white/5 cursor-pointer"
                >
                  {t('auth.signInWithEmailToggle')}
                </button>
              </div>
            )}
          </div>
