      ...
      >
        <Drawer.Content placement="bottom" className="!z-[110]">
          <Drawer.Dialog className="relative !bg-white dark:!bg-gray-900 max-h-[88vh] flex flex-col p-5 sm:p-6 pb-[calc(1.5rem_+_var(--safe-area-inset-bottom))] rounded-t-3xl border-none shadow-[0_-4px_30px_rgba(0,0,0,0.12)]">
            ...
            <Drawer.Header className="pt-2 pb-3 px-0 border-none">
              <div className="flex items-start justify-between gap-3 w-full">
                <div className="flex items-center gap-3 min-w-0 flex-1">
                  <div className="w-11 h-11 rounded-2xl bg-amber-500/10 dark:bg-amber-500/15 text-amber-600 dark:text-amber-400 flex items-center justify-center shrink-0 shadow-xs">
            ...
            {/* Body: Value Highlights & Native Feature Micro-Preview */}
                  ...
                  feature.highlights.map((highlight, idx) => {
                    ...
                    return (
                      <div key={idx} className="flex items-start gap-3">
                        <div className="w-8 h-8 rounded-xl bg-emerald-500/10 dark:bg-emerald-500/15 text-emerald-600 dark:text-emerald-400 flex items-center justify-center shrink-0 mt-0.5 shadow-xs">
                          <HighlightIcon className="w-4 h-4 stroke-[2.2]" />
                        </div>
                        <div className="min-w-0 flex-1">
                          <h4 className="text-xs font-bold text-gray-900 dark:text-gray-100 leading-snug">
                            {highlight.title}
                          </h4>
                          <p className="text-[11.5px] text-gray-500 dark:text-gray-400 leading-relaxed mt-0.5">
            ...
            <Drawer.Footer className="pt-3 px-0 flex flex-col gap-2 border-none">
              <Button
                className="w-full h-12 min-h-[48px] rounded-2xl font-bold bg-emerald-600 hover:bg-emerald-500 text-white shadow-[0_4px_16px_rgba(16,185,129,0.25)] border-none active:scale-[0.98] transition-all cursor-pointer text-sm flex items-center justify-center gap-2"
