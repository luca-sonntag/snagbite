...
export default function HealthScoreMetricsGrid({
  ...
  return (
    <div className="grid grid-cols-2 gap-2.5 select-none">
      {/* 1. Gemüse & Obst */}
      <div className="bg-white dark:bg-gray-850 p-3 sm:p-3.5 rounded-2xl ring-1 ring-black/[0.04] dark:ring-white/[0.06] shadow-xs flex flex-col justify-between border-none">
