...
export const PantrySuggestionsModal: React.FC<PantrySuggestionsModalProps> = ({
  ...
  // Deduplicate suggestions by recipe id
            ...
            uniqueSuggestions.map((sug) => {
              ...
              return (
                <div
                  ...
                  className="p-3 bg-gray-50 hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700/80 rounded-2xl cursor-pointer transition-all border-none shadow-none flex items-center gap-3.5 active:scale-[0.98]"
                >
                  {/* Thumbnail / Emoji */}
                  <div className="w-18 h-18 rounded-2xl overflow-hidden bg-gray-200 dark:bg-gray-700 shrink-0 flex items-center justify-center relative shadow-xs">
                    {img ? (
                      <img
                        src={img}
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-1.5 flex-wrap text-xs">
                      ...
                      <span className="inline-flex items-center gap-1 font-semibold text-[11px] bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 px-2 py-0.5 rounded-lg">
