    ...
    >
      <div className="flex items-center gap-3 min-w-0">
        ...
        <div className="min-w-0">
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5 truncate max-w-[14rem] sm:max-w-xs">
            {t('app.settings.premiumCardDesc') || 'Unbegrenzte Rezepte, KI-Remix & mehr'}
          </p>
        </div>
      </div>
      <button
      ...
      >
        <span>{t('app.settings.upgradePremium') || 'Upgrade'}</span>
      </button>
    </div>
  );
}
