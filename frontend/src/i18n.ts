  ...
  de: {
    ...
    catalog: {
      ...
      magazine: {
        ...
        vibes: {
          vitalHeroBadge: 'Vital & Fit Tipp',
          vitalBentoTitle: 'Weitere Vital-Favoriten',
          vitalBentoSubtitle: 'Nährstoffreich mit Health Score ab 70',
          quickHeroBadge: 'Blitz-Highlight',
          quickBentoTitle: 'Blitz-Gerichte & Nährstoff-Champions',
          quickBentoSubtitle: 'In unter 25 Minuten auf dem Tisch',
          highProteinHeroBadge: 'Top High Protein',
          highProteinBentoTitle: 'Mehr High-Protein Ideen',
          highProteinBentoSubtitle: 'Schnell zubereitet & proteinreich',
          onePotHeroBadge: 'One-Pot Highlight',
          onePotBentoTitle: 'Mehr One-Pot Ideen',
          onePotBentoSubtitle: 'Wenig Aufwand, voller Geschmack',
          veggieHeroBadge: 'Veggie-Highlight',
          veggieBentoTitle: 'Mehr Veggie-Inspirationen',
          veggieBentoSubtitle: 'Pflanzliche Vielfalt genießen',
          sweetHeroBadge: 'Süßes Highlight',
          sweetBentoTitle: 'Süße Köstlichkeiten & Desserts',
          sweetBentoSubtitle: 'Für den perfekten Genuss',
        },
  ...
  en: {
    ...
    catalog: {
      ...
      magazine: {
        ...
        vibes: {
          vitalHeroBadge: 'Vital & Fit Pick',
          vitalBentoTitle: 'More Vital & Fit Favorites',
          vitalBentoSubtitle: 'Nutrient-rich with Health Score 70+',
          quickHeroBadge: 'Quick Spotlight',
          quickBentoTitle: 'Quick Dishes & Nutrient Champions',
          quickBentoSubtitle: 'On the table in under 25 minutes',
          highProteinHeroBadge: 'Top High Protein',
          highProteinBentoTitle: 'More High-Protein Ideas',
          highProteinBentoSubtitle: 'Quick to make & high in protein',
          onePotHeroBadge: 'One-Pot Spotlight',
          onePotBentoTitle: 'More One-Pot Ideas',
          onePotBentoSubtitle: 'Minimal effort, maximum flavor',
          veggieHeroBadge: 'Veggie Spotlight',
          veggieBentoTitle: 'More Veggie Inspirations',
          veggieBentoSubtitle: 'Enjoy plant-based variety',
          sweetHeroBadge: 'Sweet Treat Spotlight',
          sweetBentoTitle: 'Sweet Treats & Desserts',
          sweetBentoSubtitle: 'For the sweet tooth',
        },
