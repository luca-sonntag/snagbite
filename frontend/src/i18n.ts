  ...
  de: {
    ...
    error: {
      ...
      codes: {
        ...
        NOT_A_RECIPE: 'In diesem Beitrag wurde kein vollständiges Rezept gefunden. Bitte stelle sicher, dass Zutaten und Zubereitung in der Beschreibung enthalten sind.',
    ...
    recipe: {
      ...
      adjustServingsTitle: 'Rezept-Aufteilung anpassen',
      adjustServingsSubtitle: 'Aktuell ist das Rezept auf {servings} Portionen ausgelegt. Auf wie viele Portionen soll das Gericht aufgeteilt werden?',
      adjustServingsSubtitleSingular: 'Aktuell ist das Rezept auf 1 Portion ausgelegt. Auf wie viele Portionen soll das Gericht aufgeteilt werden?',
      adjustServingsTargetLabel: 'Portionen',
      adjustServingsPreviewTitle: 'Nährwerte pro Portion',
      adjustServingsPreviewKcal: 'Nährwerte pro Portion ändern sich von {oldKcal} kcal auf {newKcal} kcal.',
      adjustServingsPreviewUnchanged: 'Die Nährwerte pro Portion bleiben unverändert ({kcal} kcal).',
      adjustServingsSave: 'Speichern',
      adjustServingsCancel: 'Abbrechen',
      adjustServingsSuccess: 'Rezept-Aufteilung erfolgreich angepasst',
  ...
  en: {
    ...
    error: {
      ...
      codes: {
        ...
        NOT_A_RECIPE: 'No complete recipe was found in this post. Please make sure the ingredients and instructions are included in the caption.',
    ...
    recipe: {
      ...
      adjustServingsTitle: 'Adjust Recipe Portions',
      adjustServingsSubtitle: 'Currently configured for {servings} servings. How many servings should this dish be divided into?',
      adjustServingsSubtitleSingular: 'Currently configured for 1 serving. How many servings should this dish be divided into?',
      adjustServingsTargetLabel: 'Servings',
      adjustServingsPreviewTitle: 'Nutrition per serving',
      adjustServingsPreviewKcal: 'Nutrition per serving changes from {oldKcal} kcal to {newKcal} kcal.',
      adjustServingsPreviewUnchanged: 'Nutrition per serving remains unchanged ({kcal} kcal).',
      adjustServingsSave: 'Save',
      adjustServingsCancel: 'Cancel',
      adjustServingsSuccess: 'Recipe portions successfully updated',
