...
export const uiTranslations = {
  de: {
    ...
    job: {
      ...
      progress: {
        stages: {
          ...
          awaiting_frames: 'Video-Frames erfassen...',
    ...
    shopping: {
      ...
      notInPantryYetHint: 'Noch nicht im Vorrat · Werden beim Einkauf abschließen übertragen',
  ...
  en: {
    ...
    job: {
      ...
      progress: {
        stages: {
          ...
          awaiting_frames: 'Capturing video frames...',
    ...
    shopping: {
      ...
      notInPantryYetHint: 'Not in pantry yet · Will be added when finishing shopping',
