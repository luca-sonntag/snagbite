...
export const uiTranslations = {
  de: {
    ...
    recipe: {
      ...
      adjustServingsTitle: 'Portionsgröße korrigieren',
      adjustServingsSubtitle: 'Wie viele Portionen ergibt das Gesamtrezept? Davon hängen die Nährwerte pro Portion ab.',
      adjustServingsSubtitleSingular: 'Wie viele Portionen ergibt das Gesamtrezept? Davon hängen die Nährwerte pro Portion ab.',
      ...
      scalingForToday: 'Für heute',
      scalingSubtext: 'Skaliert Zutatenmengen',
  ...
  en: {
    ...
    recipe: {
      ...
      adjustServingsTitle: 'Correct Serving Size',
      adjustServingsSubtitle: 'How many servings does the full recipe make? This determines the nutrition per serving.',
      adjustServingsSubtitleSingular: 'How many servings does the full recipe make? This determines the nutrition per serving.',
      ...
      scalingForToday: 'Scale for today',
      scalingSubtext: 'Scales ingredient amounts',
