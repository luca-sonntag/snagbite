...
export const uiTranslations = {
  de: {
    ...
    recipe: {
      ...
      healthScoreCopilotActionOptimize: 'Rezept mit Copilot optimieren',
      healthScoreCopilotActionVariations: 'Varianten mit Copilot entdecken',
  ...
  en: {
    ...
    recipe: {
      ...
      healthScoreCopilotActionOptimize: 'Optimize recipe with Copilot',
      healthScoreCopilotActionVariations: 'Explore variations with Copilot',
