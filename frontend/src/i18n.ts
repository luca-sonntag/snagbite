...
export const uiTranslations = {
  de: {
    ...
    form: {
      ...
      demoTitle: 'Beispiele ausprobieren',
      demoSubtitle: 'Tippe auf ein Beispiel, um die KI-Extraktion direkt zu testen',
    ...
    recipe: {
      ...
      adjustServingsTitle: 'Portionen anpassen',
      adjustServingsSubtitle: 'Für wie viele Portionen reicht das Gericht? Die Nährwerte werden automatisch neu aufgeteilt.',
      adjustServingsSubtitleSingular: 'Für wie viele Portionen reicht das Gericht? Die Nährwerte werden automatisch neu aufgeteilt.',
  ...
  en: {
    ...
    form: {
      ...
      demoTitle: 'Try Examples',
      demoSubtitle: 'Tap an example to test AI extraction directly',
    ...
    recipe: {
      ...
      adjustServingsTitle: 'Adjust Portions',
      adjustServingsSubtitle: 'How many servings does this dish make? Nutrition values will automatically be recalculated.',
      adjustServingsSubtitleSingular: 'How many servings does this dish make? Nutrition values will automatically be recalculated.',
