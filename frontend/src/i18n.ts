  ...
  de: {
    ...
    error: {
      ...
      codes: {
        ...
        NOT_A_RECIPE: 'Rezept nicht in der Beschreibung gefunden. Viele Creator versenden Rezepte per DM – Snagbite benötigt die Zutaten und Schritte direkt im Text des Beitrags.',
  ...
  en: {
    ...
    error: {
      ...
      codes: {
        ...
        NOT_A_RECIPE: 'Recipe not found in caption. Many creators send recipes via DM – Snagbite needs the ingredients and steps directly in the post description.',
