  ...
  de: {
    ...
    error: {
      ...
      codes: {
        ...
        NOT_A_RECIPE: 'In diesem Beitrag wurden leider keine Zutaten oder Zubereitungsschritte gefunden.',
  ...
  en: {
    ...
    error: {
      ...
      codes: {
        ...
        NOT_A_RECIPE: 'No ingredients or cooking steps were found in this post.',
