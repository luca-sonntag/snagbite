...
export const uiTranslations = {
  de: {
    ...
    recipe: {
      ...
      verifiedDatabaseTooltip: 'Nährwerte basieren auf der Schweizer Nährwertdatenbank (laborgeprüft).',
  ...
  en: {
    ...
    recipe: {
      ...
      verifiedDatabaseTooltip: 'Nutritional values are verified against the Swiss Food Composition Database.',
