  ...
  de: {
    ...
    app: {
      ...
      gamification: {
        ...
        toastDuplicate: 'Rezept als gekocht markiert (heute bereits gewertet)',
        toastCookedNoXp: 'Rezept als gekocht markiert!',
    ...
    auth: {
      ...
      signInWithEmailToggle: 'Bereits ein Konto? Mit E-Mail anmelden',
      emailSignInTitle: 'Mit E-Mail anmelden',
      emailLabel: 'E-Mail-Adresse',
      emailPlaceholder: 'deine@email.de',
      passwordLabel: 'Passwort',
      passwordPlaceholder: '••••••••',
      signInButton: 'Anmelden',
      backToGoogle: 'Zurück zum Google-Login',
      newToSnagbiteNotice: 'Neu bei Snagbite? Neue Konten werden direkt über Google erstellt.',
      startWithGoogle: 'Mit Google starten',
      invalidCredentials: 'Zugangsdaten nicht gefunden. Falls du noch kein Konto hast, melde dich bitte über Google an.',
    ...
    queue: {
      ...
      waitlistEmpty: 'Keine Rezepte in der Warteliste',
      waitlistDesc: 'Hier abgelegte Rezepte kannst du analysieren, sobald dein Tageskontingent erneuert ist.',
      btnQueueForLater: 'In Warteliste vormerken',
      btnAnalyzeNow: 'Jetzt analysieren',
      failedTitle: 'Fehlgeschlagene Versuche',
      failedNotice: 'Der Link bleibt gesichert – du kannst es jederzeit erneut versuchen.',
      btnRetry: 'Erneut versuchen',
      btnCopyLink: 'Link kopieren',
      btnOpenLink: 'Link öffnen',
      btnMoveToWaitlist: 'In Warteliste verschieben',
      btnDismiss: 'Verwerfen',
      btnClearAll: 'Alle leeren',
      dock: {
        failedOne: '1 Extraktion fehlgeschlagen',
        failedMultiple: '{count} Extraktionen fehlgeschlagen',
        waitlistOne: '1 Rezept in der Warteliste',
        waitlistMultiple: '{count} Rezepte in der Warteliste',
        startNext: 'Starten',
        retry: 'Wiederholen',
        viewAll: 'Alle anzeigen',
        sheetTitle: 'Warteliste',
      ...
      toast: {
        ...
        addedToWaitlistQuota: 'Rezept für später vorgemerkt (Tageskontingent erreicht)',
        alreadyInWaitlist: 'Dieses Rezept ist bereits in der Warteliste',
        removedFromWaitlist: 'Aus der Warteliste entfernt',
        linkCopied: 'Link in Zwischenablage kopiert',
        movedToWaitlist: 'In Warteliste verschoben',
        viewWaitlist: 'Warteliste ansehen',
      },
      smartResume: {
        title: 'Rezept in der Warteliste',
        titleMultiple: '{count} Rezepte in der Warteliste',
        subtitle: 'Dein Extraktions-Kontingent ist wieder bereit! Möchtest du dein vorgemerktes Rezept jetzt analysieren?',
        subtitleMultiple: 'Dein Extraktions-Kontingent ist wieder bereit! Möchtest du mit dem ersten vorgemerkten Rezept starten?',
        analyzeNow: 'Jetzt analysieren',
        manageWaitlist: 'Warteliste ansehen',
        later: 'Später',
      },
      timeAgo: {
        justNow: 'Gerade eben',
    ...
    form: {
      ...
      actionCards: {
        linkTitle: 'Video oder Link importieren',
        linkSubtitle: 'Instagram, TikTok, YouTube oder Webseiten-Link',
        photoTitle: 'Kochbuch scannen',
        photoSubtitle: 'Rezeptseite oder handgeschriebene Notiz fotografieren',
      },
      sheet: {
        linkTitle: 'Video oder Link importieren',
        linkSubtitle: 'Füge einen Rezept-Link aus sozialen Medien oder von einer Website ein.',
        photoTitle: 'Kochbuch scannen',
        photoSubtitle: 'Fotografiere eine Rezeptseite oder wähle Bilder aus der Galerie.',
      },
      ...
      demoTitle: 'Inspiration fürs Kochbuch',
      demoSubtitle: 'Tippe auf ein Rezept für eine Vorschau und speichere es in dein Kochbuch',
      demoSaveAction: 'Ins Kochbuch',
      demoSavedAction: 'Im Kochbuch',
      demoSavingAction: 'Speichern...',
      demoViewAction: 'Rezept ansehen',
    ...
    recipe: {
      ...
      preview: {
        ...
        subtitle: 'Öffentliches Community-Rezept',
        saveAction: 'Ins Kochbuch speichern',
        alreadySavedAction: 'Bereits im Kochbuch',
        savingAction: 'Wird gespeichert...',
        viewInCookbook: 'Zum Rezept',
        ingredients: 'Zutaten',
      },
      ...
      nutritionSugar: 'Zucker',
      healthScoreTitle: 'Healthy Score',
      healthScoreGradeExcellent: 'Nährstoff-Powerhouse',
      healthScoreGradeBalanced: 'Ausgewogen & Gesund',
      healthScoreGradeSolid: 'Solide Mahlzeit',
      healthScoreGradeIndulgent: 'Gehaltvoller Genuss',
      healthScoreGradeCheatMeal: 'Schlemmergericht',
      healthScoreSheetSubtitle: 'Wissenschaftlich fundierte 4-Säulen-Bewertung',
      healthScorePillarMacro: 'Makro- & Energie-Balance',
      healthScorePillarFiber: 'Ballaststoffe & Sättigung',
      healthScorePillarPlant: 'Pflanzenkraft & Vielfalt',
      healthScorePillarPurity: 'Zutaten-Reinheit & NOVA',
      healthScoreVegetableAmount: '{grams}g Gemüse / Obst',
      healthScorePlantCount: '{count} Pflanzenzutaten',
      healthScoreFiberAmount: '{grams}g Ballaststoffe',
      healthScoreSugarAmount: '{grams}g Zucker',
      healthScoreAverageNova: 'NOVA {nova}',
      healthScoreHighlightsTitle: 'Pluspunkte',
      healthScoreCautionsTitle: 'Zu beachten',
      healthScoreSmartSwapTitle: 'Smarter Tipp',
      healthScoreActionSwapTitle: 'Nährwerte verbessern & optimieren',
      healthScoreActionSwapSubtitle: 'Vorschläge für bessere Nährwerte ansehen',
      healthScoreActionVariationsTitle: 'Rezept variieren & ergänzen',
      healthScoreActionVariationsSubtitle: 'Ideen für Beilagen und feine Abwandlungen',
    ...
    catalog: {
      ...
      quickStart: {
        title: 'Starte dein Kochbuch',
        description: 'Füge eigene Rezepte per Link oder Foto hinzu, oder entdecke Inspirationen unten.',
        addRecipe: 'Rezept hinzufügen',
        scanPhoto: 'Foto scannen',
        discoverTitle: 'Inspirationen entdecken',
      },
      ...
      greeting: {
        ...
        evening: 'Guten Abend',
        sundayEvening: 'Schönen Sonntagabend',
        weekend: 'Schönes Wochenende',
        night: 'Gute Nacht',
        subtitleMorning: 'Zeit für ein gutes Frühstück?',
        subtitleNoon: 'Schnelle & leichte Küche?',
        subtitleEvening: 'Feierabend! Was kochen wir heute?',
        subtitleNight: 'Appetit auf einen späten Snack?',
        subtitleWeekend: 'Zeit für neue Koch-Ideen?',
        subtitleMorning1: 'Zeit für ein gutes Frühstück?',
        subtitleMorning2: 'Frisch in den Tag starten!',
        subtitleMorning3: 'Kaffee & ein leckeres Frühstück?',
        subtitleMorningWeekend1: 'Zeit für ein langes Frühstück?',
        subtitleMorningWeekend2: 'Entspannter Wochenend-Brunch?',
        subtitleNoon1: 'Schnelle & leichte Küche?',
        subtitleNoon2: 'Zeit für eine Mittagspause!',
        subtitleNoon3: 'Was gibt es zum Mittagessen?',
        subtitleNoonWeekend1: 'Ausgiebiger Brunch oder Lunch?',
        subtitleNoonWeekend2: 'Wochenend-Küche zum Genießen!',
        subtitleAfternoon1: 'Lust auf einen Snack?',
        subtitleAfternoon2: 'Kaffeezeit! Lust auf Süßes?',
        subtitleAfternoonWeekend1: 'Kaffee & Kuchen gefällig?',
        subtitleAfternoonWeekend2: 'Gemütlicher Nachmittagssnack?',
        subtitleEvening1: 'Feierabend! Was kochen wir heute?',
        subtitleEvening2: 'Der Feierabend ruft – was gibt\'s?',
        subtitleEvening3: 'Zeit für ein schnelles Abendessen!',
        subtitleFridayEvening1: 'Endlich Wochenende! Was kochen wir?',
        subtitleFridayEvening2: 'Freitagabend: Zeit für Seelenfutter!',
        subtitleSaturdayEvening1: 'Samstagabend: Zeit zum Genießen!',
        subtitleSaturdayEvening2: 'Lust auf ein Koch-Highlight?',
        subtitleSundayEvening1: 'Sonntagsessen: Was kochen wir?',
        subtitleSundayEvening2: 'Gemütlicher Sonntagabend!',
        subtitleSundayEvening3: 'Was Leckeres zum Sonntag?',
        subtitleLateEvening1: 'Noch ein kleiner Abendsnack?',
        subtitleLateEvening2: 'Lust auf einen späten Snack?',
        subtitleLateEvening3: 'Schon Ideen für morgen?',
        subtitleLateFriday1: 'Lust auf späte Knabbereien?',
        subtitleLateSaturday1: 'Snack für den Filmabend?',
        subtitleLateSunday1: 'Lust auf einen späten Snack?',
        subtitleLateSunday2: 'Sonntag entspannt ausklingen lassen?',
        subtitleLateSunday3: 'Noch Lust auf eine Kleinigkeit?',
        subtitleNight1: 'Lust auf einen Mitternachtssnack?',
        subtitleNight2: 'Später Hunger? Snack gefällig?',
        subtitleNight3: 'Mitten in der Nacht am Schmökern?',
      },
      storyHub: {
      ...
      magazine: {
        ...
        heroThemeRecipesCount: '{count} Rezepte',
        themeSheetSubtitle: '{count} passende Rezepte in deinem Kochbuch',
        themeSheetOpenCatalog: 'Im Katalog ansehen',
        vitalSheetTitle: 'Deine Vital-Stars',
        vitalSheetSubtitle: '{count} nährstoffreiche Rezepte in deinem Kochbuch',
        ...
        bentoSubtitle: 'In unter 25 Minuten auf dem Tisch',
        bentoDefaultTitle: 'Schnelle Alternativen für heute',
        bentoDefaultSubtitle: 'In unter 25 Minuten auf dem Tisch',
        bentoContextTitle: 'Dazu passende Inspirationen',
        bentoContextSubtitle: 'Perfekt abgestimmt auf heute',
        rediscoveredTitle: 'Wiederentdeckt für dich',
        rediscoveredSubtitle: 'Vor über {days} Tagen gespeichert & noch nicht probiert',
        savedOn: 'Gespeichert am {date}',
        allShelfTitle: 'Alle deine Rezepte',
        allShelfSubtitle: 'Deine vollständige Sammlung chronologisch sortiert',
        allShelfButton: 'Alle {count} Rezepte durchsuchen & filtern',
        timelineToday: 'Heute',
        timelineYesterday: 'Gestern',
        timelineThisWeek: 'Diese Woche',
        timelineLastWeek: 'Letzte Woche',
        timelineShowMore: 'Mehr in der Chronik anzeigen ({count})',
        vegGrams: '{grams}g Gemüse & Obst',
      },
    ...
    shopping: {
      ...
      empty: {
        ...
        desc: 'Füge Zutaten aus deinen Rezepten mit 1 Klick hinzu oder ergänze eigene Artikel – automatisch nach Supermarkt-Kategorien sortiert.',
        cta: 'Rezepte entdecken',
      },
      emptyState: {
        welcomeTitle: 'Deine Einkaufsliste ist leer',
        welcomeDesc: 'Füge Zutaten aus deinen Rezepten mit 1 Klick hinzu oder ergänze eigene Artikel – automatisch nach Supermarkt-Kategorien sortiert.',
        ctaButton: 'Rezepte entdecken',
    ...
    copilot: {
      ...
      autoVariantPrompt: 'Welche leckeren Varianten oder Abwandlungen kannst du für dieses Rezept vorschlagen?',
      ...
      chipRecalculateNutrition: 'Nährwerte neu berechnen',
      loading: 'Antwortet...',
      ...
      updateTitleLabel: 'Titel anpassen',
    ...
    premium: {
      modal: {
        ...
        comparison: {
          tableTitle: 'Free vs. PRO im Vergleich',
        ...
        featuresTitle: 'Alle PRO-Vorteile',
        features: {
          extractions: {
    ...
    mealPlanner: {
      ...
      addError: 'Fehler beim Planen des Rezepts',
      ...
      planNextWeek: 'Nächste Woche planen ({range})',
      expandWeek: 'Woche planen ({range})',
      addRecipe: 'Rezept hinzufügen',
      ...
      dayEmptyBannerTitle: 'Kein Rezept für diesen Tag geplant',
      dayEmptyBannerSubtitle: 'Tippe auf den Button, um ein Rezept einzuplanen.',
      upcomingTitle: 'Zukünftig geplante Rezepte',
      upcomingCount: '{count} Rezepte',
      upcomingCountSingle: '1 Rezept',
      tomorrow: 'Morgen',
      dayAfterTomorrow: 'Übermorgen',
      allCooked: 'Alle geplanten Rezepte dieser Woche wurden bereits gekocht.',
      addRecipeForDay: 'Rezept für {date} planen',
      ...
      cookTodayAndPull: 'Heute kochen & vorziehen',
      movedToToday: 'Gericht auf heute vorgezogen',
      doneBadge: 'Erledigt',
  ...
  en: {
    ...
    app: {
      ...
      gamification: {
        ...
        toastDuplicate: 'Recipe marked as cooked (already counted today)',
        toastCookedNoXp: 'Recipe marked as cooked!',
    ...
    auth: {
      ...
      signInWithEmailToggle: 'Already have an account? Sign in with email',
      ...
      newToSnagbiteNotice: 'New to Snagbite? New accounts are created with Google.',
      startWithGoogle: 'Get started with Google',
      invalidCredentials: 'Credentials not found. If you are new, please sign in with Google.',
    ...
    queue: {
      ...
      waitlistEmpty: 'No recipes in waitlist',
      waitlistDesc: 'Recipes saved here can be analyzed once your daily quota resets.',
      btnQueueForLater: 'Save to waitlist',
      btnAnalyzeNow: 'Analyze now',
      failedTitle: 'Failed extractions',
      failedNotice: 'Your links are safely preserved — you can retry anytime.',
      btnRetry: 'Retry',
      btnCopyLink: 'Copy link',
      btnOpenLink: 'Open link',
      btnMoveToWaitlist: 'Move to waitlist',
      btnDismiss: 'Dismiss',
      btnClearAll: 'Clear all',
      dock: {
        failedOne: '1 extraction failed',
        failedMultiple: '{count} extractions failed',
        waitlistOne: '1 recipe in waitlist',
        waitlistMultiple: '{count} recipes in waitlist',
        startNext: 'Start',
        retry: 'Retry',
        viewAll: 'View all',
        sheetTitle: 'Waitlist',
      ...
      toast: {
        ...
        addedToWaitlistQuota: 'Recipe saved to waitlist (daily limit reached)',
        alreadyInWaitlist: 'This recipe is already in your waitlist',
        removedFromWaitlist: 'Removed from waitlist',
        linkCopied: 'Link copied to clipboard',
        movedToWaitlist: 'Moved to waitlist',
        viewWaitlist: 'View waitlist',
      },
      smartResume: {
        title: 'Recipe in your waitlist',
        titleMultiple: '{count} recipes in your waitlist',
        subtitle: 'Your daily extraction quota is refreshed! Would you like to analyze your saved recipe now?',
        subtitleMultiple: 'Your daily extraction quota is refreshed! Would you like to start with your first saved recipe?',
        analyzeNow: 'Analyze now',
        manageWaitlist: 'View waitlist',
        later: 'Later',
      },
      timeAgo: {
        justNow: 'Just now',
    ...
    form: {
      ...
      pasteAction: 'Paste',
      actionCards: {
        linkTitle: 'Import Video or Link',
        linkSubtitle: 'Instagram, TikTok, YouTube or website link',
        photoTitle: 'Scan Cookbook',
        photoSubtitle: 'Photograph a cookbook page or handwritten note',
      },
      sheet: {
        linkTitle: 'Import Video or Link',
        linkSubtitle: 'Paste a recipe link from social media or any website.',
        photoTitle: 'Scan Cookbook',
        photoSubtitle: 'Photograph a recipe page or choose pictures from gallery.',
      },
      ...
      demoTitle: 'Cookbook Inspiration',
      demoSubtitle: 'Tap a recipe to preview and save it to your cookbook',
      demoSaveAction: 'To Cookbook',
      demoSavedAction: 'In Cookbook',
      demoSavingAction: 'Saving...',
      demoViewAction: 'View Recipe',
    ...
    recipe: {
      ...
      preview: {
        ...
        subtitle: 'Public recipe',
        saveAction: 'Save to Cookbook',
        alreadySavedAction: 'Already in Cookbook',
        savingAction: 'Saving...',
        viewInCookbook: 'Open Recipe',
      ...
      healthScoreTitle: 'Healthy Score',
      healthScoreGradeExcellent: 'Nutrient Powerhouse',
      healthScoreGradeBalanced: 'Balanced & Healthy',
      healthScoreGradeSolid: 'Solid Everyday Meal',
      healthScoreGradeIndulgent: 'Rich Indulgence',
      healthScoreGradeCheatMeal: 'Treat Dish',
      healthScoreSheetSubtitle: 'Science-backed 4-pillar nutrition score',
      healthScorePillarMacro: 'Macro & Energy Balance',
      healthScorePillarFiber: 'Fiber & Satiety',
      healthScorePillarPlant: 'Plant Power & Diversity',
      healthScorePillarPurity: 'Ingredient Purity & NOVA',
      healthScoreVegetableAmount: '{grams}g Veggies & Fruit',
      healthScorePlantCount: '{count} Plant Ingredients',
      healthScoreFiberAmount: '{grams}g Fiber',
      healthScoreSugarAmount: '{grams}g Sugar',
      healthScoreAverageNova: 'NOVA {nova}',
      healthScoreHighlightsTitle: 'Highlights',
      healthScoreCautionsTitle: 'Things to Note',
      healthScoreSmartSwapTitle: 'Smart Tip',
      healthScoreActionSwapTitle: 'Optimize & improve nutrition',
      healthScoreActionSwapSubtitle: 'See suggestions to improve nutrient density',
      healthScoreActionVariationsTitle: 'Explore variations & sides',
      healthScoreActionVariationsSubtitle: 'Fresh ideas for twists and fitting sides',
    ...
    catalog: {
      ...
      quickStart: {
        ...
        description: 'Add your own recipes via link or photo, or discover inspirations below.',
        addRecipe: 'Add recipe',
        scanPhoto: 'Scan photo',
        discoverTitle: 'Discover inspirations',
      },
      ...
      greeting: {
        ...
        sundayEvening: 'Happy Sunday evening',
        weekend: 'Happy weekend',
        night: 'Good night',
        subtitleMorning: 'Time for breakfast?',
        subtitleNoon: 'Quick & easy lunch?',
        subtitleEvening: 'Feierabend! What\'s for dinner?',
        subtitleNight: 'Craving a late night bite?',
        subtitleWeekend: 'Time for new recipe ideas?',
        subtitleMorning1: 'Time for breakfast?',
        subtitleMorning2: 'Fresh start into the day!',
        subtitleMorning3: 'Coffee & a tasty breakfast?',
        subtitleMorningWeekend1: 'Time for a long breakfast?',
        subtitleMorningWeekend2: 'Relaxed weekend brunch?',
        subtitleNoon1: 'Quick & easy lunch?',
        subtitleNoon2: 'Time for a lunch break!',
        subtitleNoon3: 'What\'s for lunch today?',
        subtitleNoonWeekend1: 'Lazy brunch or lunch?',
        subtitleNoonWeekend2: 'Weekend cooking to savor!',
        subtitleAfternoon1: 'Craving a snack?',
        subtitleAfternoon2: 'Coffee time! Sweet treat?',
        subtitleAfternoonWeekend1: 'Coffee & treats?',
        subtitleAfternoonWeekend2: 'Cozy afternoon snack?',
        subtitleEvening1: 'Feierabend! What\'s for dinner?',
        subtitleEvening2: 'Work is done – what\'s cooking?',
        subtitleEvening3: 'Time for a quick dinner!',
        subtitleFridayEvening1: 'Weekend is here! What\'s for dinner?',
        subtitleFridayEvening2: 'Friday night comfort food!',
        subtitleSaturdayEvening1: 'Saturday night cooking!',
        subtitleSaturdayEvening2: 'Time for a culinary highlight?',
        subtitleSundayEvening1: 'Sunday dinner: what are we making?',
        subtitleSundayEvening2: 'Cozy Sunday evening!',
        subtitleSundayEvening3: 'Something delicious for Sunday?',
        subtitleLateEvening1: 'Quick evening snack?',
        subtitleLateEvening2: 'Late night cravings?',
        subtitleLateEvening3: 'Any plans for tomorrow?',
        subtitleLateFriday1: 'Late night snacks & treats?',
        subtitleLateSaturday1: 'Snacks for movie night?',
        subtitleLateSunday1: 'Craving a late night bite?',
        subtitleLateSunday2: 'Winding down Sunday peacefully?',
        subtitleLateSunday3: 'Any late night cravings?',
        subtitleNight1: 'Craving a midnight snack?',
        subtitleNight2: 'Midnight hunger striking?',
        subtitleNight3: 'Midnight recipe hunting?',
      },
      storyHub: {
      ...
      magazine: {
        ...
        heroThemeRecipesCount: '{count} recipes',
        themeSheetSubtitle: '{count} matching recipes in your cookbook',
        themeSheetOpenCatalog: 'View in catalog',
        vitalSheetTitle: 'Your Vital Stars',
        vitalSheetSubtitle: '{count} nutrient-dense recipes in your cookbook',
        saveToCookbook: 'Save to cookbook',
        alreadySaved: 'Already saved',
        heroCookNow: 'Cook now',
        scoreBadge: 'Score {score} • {letter}',
        bentoTitle: 'Quick Dishes & Nutrient Champions',
        bentoSubtitle: 'On the table in under 25 minutes',
        bentoDefaultTitle: 'Quick Alternatives for Today',
        bentoDefaultSubtitle: 'On the table in under 25 minutes',
        bentoContextTitle: 'Complementary Inspirations',
        bentoContextSubtitle: 'Curated for today',
        rediscoveredTitle: 'Rediscovered for you',
        rediscoveredSubtitle: 'Saved over {days} days ago & untried',
        savedOn: 'Saved on {date}',
        allShelfTitle: 'All your recipes',
        allShelfSubtitle: 'Your complete collection sorted chronologically',
        allShelfButton: 'Browse & filter all {count} recipes',
        timelineToday: 'Today',
        timelineYesterday: 'Yesterday',
        timelineThisWeek: 'This week',
        timelineLastWeek: 'Last week',
        timelineShowMore: 'Show more in timeline ({count})',
        vegGrams: '{grams}g Veggies & Fruit',
      },
    ...
    shopping: {
      ...
      empty: {
        ...
        desc: 'Add ingredients from your saved recipes with 1 tap or add custom items – automatically sorted by supermarket aisle.',
        cta: 'Discover recipes',
      },
      emptyState: {
        welcomeTitle: 'Your shopping list is empty',
        welcomeDesc: 'Add ingredients from your saved recipes with 1 tap or add custom items – automatically sorted by supermarket aisle.',
        ctaButton: 'Discover recipes',
    ...
    copilot: {
      ...
      autoVariantPrompt: 'What delicious variations or twists can you suggest for this recipe?',
      ...
      chipRecalculateNutrition: 'Recalculate nutrition',
      loading: 'Responding...',
    ...
    premium: {
      modal: {
        ...
        comparison: {
          tableTitle: 'Free vs. PRO Comparison',
        ...
        featuresTitle: 'All PRO Features',
        features: {
          extractions: {
    ...
    mealPlanner: {
      ...
      addError: 'Failed to plan recipe',
      ...
      planNextWeek: 'Plan next week ({range})',
      expandWeek: 'Plan week ({range})',
      addRecipe: 'Add recipe',
      ...
      dayEmptyBannerTitle: 'No recipe planned for this day',
      dayEmptyBannerSubtitle: 'Tap the button to plan a recipe for this day.',
      upcomingTitle: 'Upcoming planned recipes',
      upcomingCount: '{count} recipes',
      upcomingCountSingle: '1 recipe',
      tomorrow: 'Tomorrow',
      dayAfterTomorrow: 'Day after tomorrow',
      allCooked: 'All planned recipes for this week have already been cooked.',
      addRecipeForDay: 'Plan recipe for {date}',
      ...
      cookTodayAndPull: 'Cook today & move',
      movedToToday: 'Moved dish to today',
      doneBadge: 'Done',
