  ...
  de: {
    ...
    catalog: {
      ...
      greeting: {
        ...
        night: 'Gute Nacht',
        subtitleMorning: 'Zeit für ein stärkendes Frühstück?',
        subtitleNoon: 'Schnelle Mittagspause & leichte Küche?',
        subtitleEvening: 'Feierabend! Was kochen wir heute?',
        subtitleNight: 'Appetit auf einen späten Snack?',
        subtitleWeekend: 'Zeit für Genuss & neue Koch-Inspirationen?',
        subtitleMorning1: 'Zeit für ein stärkendes Frühstück?',
        subtitleMorning2: 'Frisch in den Tag – was darf es zum Frühstück sein?',
        subtitleMorning3: 'Erstmal Kaffee und ein gutes Frühstück?',
        subtitleMorningWeekend1: 'Zeit für ein langes Wochenend-Frühstück?',
        subtitleMorningWeekend2: 'Ausgiebiger Brunch oder entspannter Start in den Tag?',
        subtitleNoon1: 'Schnelle Mittagspause & leichte Küche?',
        subtitleNoon2: 'Zeit für eine stärkende Mittagspause!',
        subtitleNoon3: 'Etwas Frisches & Schnelles für die Pause?',
        subtitleNoonWeekend1: 'Ausgiebiger Brunch oder leckeres Mittagessen?',
        subtitleNoonWeekend2: 'Wochenend-Küche: Zeit für Genuss & neue Rezepte!',
        subtitleAfternoon1: 'Kleine Pause oder Lust auf einen Nachmittags-Snack?',
        subtitleAfternoon2: 'Kaffeezeit! Lust auf etwas Süßes oder Herzhaftes?',
        subtitleAfternoonWeekend1: 'Kaffee & Kuchen oder ein kleiner Genuss-Snack?',
        subtitleAfternoonWeekend2: 'Gemütlicher Nachmittag – Zeit zum Backen oder Schlemmen?',
        subtitleEvening1: 'Feierabend! Was kochen wir heute?',
        subtitleEvening2: 'Der Feierabend ruft – was gibt es heute Gutes?',
        subtitleEvening3: 'Zeit für ein schnelles, leckeres Abendessen!',
        subtitleFridayEvening1: 'Endlich Wochenende! Was gönnen wir uns heute?',
        subtitleFridayEvening2: 'Freitagabend – Zeit für dein Lieblingsessen!',
        subtitleSaturdayEvening1: 'Samstagabend! Lust auf ein echtes Koch-Highlight?',
        subtitleSaturdayEvening2: 'Zeit für Genuss – was zaubern wir heute?',
        subtitleSundayEvening1: 'Gemütlicher Sonntagabend – was gibt es Leckeres?',
        subtitleSundayEvening2: 'Sonntagsessen: Den Tag köstlich abrunden!',
        subtitleSundayEvening3: 'Den Sonntag entspannt bei gutem Essen ausklingen lassen...',
        subtitleLateEvening1: 'Den Tag entspannt ausklingen lassen – noch ein kleiner Snack?',
        subtitleLateEvening2: 'Appetit auf eine Kleinigkeit zu später Stunde?',
        subtitleLateEvening3: 'Kleine Stärkung oder schon Rezeptideen für morgen?',
        subtitleLateFriday1: 'Der Abend ist noch jung – Appetit auf Knabbereien?',
        subtitleLateSaturday1: 'Später Snack für den Filmabend oder die Runde?',
        subtitleLateSunday1: 'Den Sonntag ruhig ausklingen lassen – noch ein Snack?',
        subtitleLateSunday2: 'Noch Lust auf eine Kleinigkeit oder Ideen für die neue Woche?',
        subtitleLateSunday3: 'Entspannt in die neue Woche – Appetit auf einen späten Happen?',
        subtitleNight1: 'Nachtaktiver Feinschmecker? Lust auf einen Mitternachtssnack?',
        subtitleNight2: 'Appetit auf einen schnellen Snack zu später Stunde?',
        subtitleNight3: 'Mitten in der Nacht auf Rezeptsuche?',
      },
      storyHub: {
  ...
  en: {
    ...
    catalog: {
      ...
      greeting: {
        ...
        night: 'Good night',
        subtitleMorning: 'Time for a nourishing breakfast?',
        subtitleNoon: 'Quick lunch break or fresh bites?',
        subtitleEvening: 'Evening time! What are we cooking tonight?',
        subtitleNight: 'Craving a late night bite?',
        subtitleWeekend: 'Time to enjoy and explore new recipes?',
        subtitleMorning1: 'Time for a nourishing breakfast?',
        subtitleMorning2: 'Start the day right – what are we making for breakfast?',
        subtitleMorning3: 'First coffee, then a wholesome breakfast?',
        subtitleMorningWeekend1: 'Time for a cozy, slow weekend breakfast?',
        subtitleMorningWeekend2: 'Leisurely brunch or relaxed start into the day?',
        subtitleNoon1: 'Quick lunch break or fresh bites?',
        subtitleNoon2: 'Recharge time! What are we cooking for lunch?',
        subtitleNoon3: 'Something fresh and quick for your lunch break?',
        subtitleNoonWeekend1: 'Leisurely brunch or a hearty weekend lunch?',
        subtitleNoonWeekend2: 'Weekend cooking: time to enjoy & explore new dishes!',
        subtitleAfternoon1: 'Quick afternoon break or craving a snack?',
        subtitleAfternoon2: 'Coffee break! Sweet treat or savory bite?',
        subtitleAfternoonWeekend1: 'Coffee & treats or an afternoon savory snack?',
        subtitleAfternoonWeekend2: 'Relaxed afternoon: time to bake or discover new recipes?',
        subtitleEvening1: 'Evening time! What are we cooking tonight?',
        subtitleEvening2: 'Work is done – what delicious dinner awaits?',
        subtitleEvening3: 'Time for a quick, comforting dinner!',
        subtitleFridayEvening1: 'Weekend is here! What treat are we celebrating with?',
        subtitleFridayEvening2: 'Friday night – time for your favorite comfort food!',
        subtitleSaturdayEvening1: 'Saturday night! Ready for a special culinary highlight?',
        subtitleSaturdayEvening2: 'Pure indulgence – what are we creating tonight?',
        subtitleSundayEvening1: 'Cozy Sunday evening – what are we enjoying tonight?',
        subtitleSundayEvening2: 'Sunday dinner: wrapping up the day with delicious food!',
        subtitleSundayEvening3: 'Winding down Sunday with good comforting food...',
        subtitleLateEvening1: 'Winding down the day – craving a light evening bite?',
        subtitleLateEvening2: 'Late night cravings or planning tomorrow’s meals?',
        subtitleLateEvening3: 'Comforting bedtime treat or quick late-night snack?',
        subtitleLateFriday1: 'The night is still young – craving a savory bite?',
        subtitleLateSaturday1: 'Late night snack for movie night or relaxing hours?',
        subtitleLateSunday1: 'Winding down Sunday peacefully – craving a small bite?',
        subtitleLateSunday2: 'Relaxed end to Sunday – gathering ideas for the new week?',
        subtitleLateSunday3: 'Heading into the week relaxed – late night treat?',
        subtitleNight1: 'Night owl foodie? Craving a midnight snack?',
        subtitleNight2: 'Late-night cravings striking again?',
        subtitleNight3: 'Hunting for midnight inspiration in your cookbook?',
      },
      storyHub: {
