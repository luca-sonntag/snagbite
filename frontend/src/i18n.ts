...
export const uiTranslations = {
  de: {
    ...
    recipe: {
      ...
      healthScoreCopilotTitle: 'Rezept gesünder machen mit KI',
      healthScoreCopilotSubtitle: 'Lass dir vom Copilot konkrete Zutaten-Alternativen und Gemüsekombinationen vorschlagen, um deinen Score zu steigern.',
      healthScoreCopilotAction: 'KI nach Upgrades fragen',
  ...
  en: {
    ...
    recipe: {
      ...
      healthScoreCopilotTitle: 'Make recipe healthier with AI',
      healthScoreCopilotSubtitle: 'Let the Copilot suggest concrete ingredient swaps and vegetable additions to boost your score.',
      healthScoreCopilotAction: 'Ask AI for upgrades',
