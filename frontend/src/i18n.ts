...
export const uiTranslations = {
  de: {
    ...
    recipe: {
      ...
      healthScoreActionSwap: 'Zutaten gesünder austauschen',
      healthScoreActionSwapHint: 'Vorschläge',
      healthScoreActionVariations: 'Rezept variieren & ergänzen',
      healthScoreActionVariationsHint: 'Ideen',
  ...
  en: {
    ...
    recipe: {
      ...
      healthScoreActionSwap: 'Swap ingredients for better health',
      healthScoreActionSwapHint: 'Suggestions',
      healthScoreActionVariations: 'Explore variations & sides',
      healthScoreActionVariationsHint: 'Ideas',
