...
const ingredientItemSchemaProperties = {
  name: {
    ...
    description: 'The clean basic name of the ingredient as bought in stores in the recipe language, stripped of brand names, quantities, numbers, and units (e.g. use "Frischkäse" instead of "Philadelphia Frischkäse", "Gouda" instead of "Leerdammer Gouda", "Salatcreme" instead of "Miracle Whip Balance", "Butter" instead of "Leichte Butter", "Parmesan" instead of "Parmesan, gerieben", "Hähnchenbrust" instead of "Hähnchenbrustfilet, gewürfelt"). PRODUCT FORM & IDENTITY INVARIANCE: The "name" represents the concrete retail commodity. NEVER collapse confectioned supermarket commodities to generic raw umbrella terms (e.g. use "Gratinkäse" / "Reibekäse" / "shredded cheese", NEVER generic "Käse" / "cheese"; use "Rinderhackfleisch" / "ground beef", NEVER generic "Rindfleisch" / "beef"; use "Tomatenmark" / "tomato paste", NEVER generic "Tomate"; use "Haferflocken" / "rolled oats", NEVER generic "Hafer"; use "Paniermehl" / "breadcrumbs", NEVER generic "Brot"; use "Röstzwiebeln" / "fried onions", NEVER generic "Zwiebel"). Commercial compound nouns (e.g. "Gratinkäse", "Reibekäse", "Pizzakäse", "Paprikapulver", "Knoblauchpulver", "Backpulver", "Mandelmehl", "Olivenöl", "Tomatenmark", "Kochschinken", "Schlagsahne", "Frischkäse") MUST remain fully intact as compound words in "name". Only real culinary states or adjectives (e.g. "leicht", "mager", "fettreduziert", "zuckerfrei", "ohne Knochen", "Bio", "TK") belong in the "modifier" field.',
  },
  brand: {
    type: FunctionDeclarationSchemaType.STRING,
...
const CLEAN_INGREDIENT_NAMES_INSTRUCTION = 'Ensure the "name" field contains the concrete retail grocery product as bought in stores, stripped of brand names, quantities, numbers, and units (e.g. use "Frischkäse" instead of "Philadelphia Frischkäse", "Gouda" instead of "Leerdammer Gouda", "Salatcreme" instead of "Miracle Whip Balance", "Butter" instead of "Leichte Butter", "Parmesan" instead of "Parmesan, gerieben"). PRODUCT FORM & IDENTITY INVARIANCE: NEVER collapse confectioned supermarket commodities into raw umbrella terms: if an ingredient is sold in a distinct physical form, cut, or industrial confection, "name" MUST specify that retail commodity form and NEVER collapse to the generic raw commodity umbrella term (e.g. use "Gratinkäse" / "Reibekäse" / "shredded cheese", NEVER generic "Käse" / "cheese"; use "Rinderhackfleisch" / "ground beef", NEVER generic "Rindfleisch" / "beef"; use "Tomatenmark" / "tomato paste", NEVER generic "Tomate"; use "Haferflocken" / "rolled oats", NEVER generic "Hafer"; use "Paniermehl" / "breadcrumbs", NEVER generic "Brot"; use "Röstzwiebeln" / "fried onions", NEVER generic "Zwiebel"). Retain commercial compound nouns (e.g. "Gratinkäse", "Reibekäse", "Pizzakäse", "Streukäse", "Paprikapulver", "Knoblauchpulver", "Backpulver", "Mandelmehl", "Olivenöl", "Tomatenmark", "Kochschinken", "Schlagsahne", "Frischkäse"). Move manufacturer/brand names (e.g. "Eat Lean", "Philadelphia", "Nutella", "Alpro", "Exquisa", "Oatly", "Buko", "More Nutrition") into the "brand" field. Move only shopping-relevant attributes (e.g. "fettreduziert", "zuckerfrei", "mager", "leicht", "light", "low fat", "ohne Knochen", "Bio", "TK") into the "modifier" field.';
