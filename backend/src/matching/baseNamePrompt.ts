...
export const BASE_NAME_SCHEMA_DESCRIPTION =
  ...
  '- For dairy/grains: "cottage cheese" for Hüttenkäse, "rolled oat" for Haferflocken, "heavy cream" for Schlagsahne, "sour cream" for Saure Sahne/Schmand, "tortilla wrap" for Wraps.\n' +
  ...
  '- AS BOUGHT IN STORES: Always describe the grocery ingredient AS BOUGHT, NEVER as prepared in this recipe. Strictly DO NOT include cooking states ("steamed", "boiled", "peeled", "cooked", "baked", "roasted", "canned", "fried", "diced", "grated", "raw" - use "apple" NOT "steamed apple", "potato" NOT "boiled potato", "carrot" NOT "diced carrots", "mozzarella" NOT "grated mozzarella").\n' +
  ...
  '- But NEVER omit a word that defines the food identity itself: Keep "powder", "flour", "oil", "juice", "sauce", "milk", "cheese", "flakes", "dried", "smoked", "ground" (for minced meat), the animal species, and the cut of meat/organ: "paprika powder" stays "paprika powder", "chicken breast" stays "chicken breast", "black pepper" stays "black pepper".\n' +
