...
7. FORM FACTOR & FOOD PHOTOGRAPHY AUDIT (correctedImagePrompt):
   ...
   - Baking Vessel Geometry Alignment: If instructions or equipment indicate a rectangular or square baking dish/casserole form (or loaf tin), ensure imagePrompt specifies "rectangular ceramic baking dish" or "square baking pan", NOT generic or round pie dishes.
